...
*Note*: This version of JabRef is not necessarily up to date with the latest commits of the official jabref. As it is used for development in a software-engineering course, which benefits from stability, not all changes are synchronized. 
