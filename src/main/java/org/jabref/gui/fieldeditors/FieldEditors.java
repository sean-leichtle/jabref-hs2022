...
public class FieldEditors {
    ...
    public static FieldEditorFX getForField(final Field field,
        ...
        } else if (field == StandardField.ABSTRACT) {
            // sets the AbstractField to a new contextmenu
           return new AbstractAreaEditor(field, suggestionProvider, fieldCheckers, preferences, dialogService);
        } else {
            // default
