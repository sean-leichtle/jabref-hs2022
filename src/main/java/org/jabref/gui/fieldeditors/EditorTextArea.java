...
/**
 * Editor for ContextMenus in fields with longer text.
 **/
...
public class EditorTextArea extends javafx.scene.control.TextArea implements Initializable, ContextMenuAddable {
    ...
    /**
     * Set the contextmenu for e.g. when you right-click on the abstract field.
     * @param items the menuitems given by the supplier.
     */
    @Override
